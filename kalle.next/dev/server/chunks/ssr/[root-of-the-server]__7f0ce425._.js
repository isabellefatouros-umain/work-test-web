...
(()=>{
    const e = new Error("Cannot find module './views/suspenseView.jsx'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module './views/sidebarFilterView.jsx'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module './views/topbarFilterView.jsx'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module './views/filterResultsView.jsx'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
;
;
const SidebarFilter = observer(function FilterRender(props) {
    function onTopFilterChangedACB(query) {
        props.model.setSearchQuery(query);
        console.log(query);
    }
...
;
;
const TopbarFilter = observer(function FilterRender(props) {
    function onTopFilterChangedACB(query) {
        props.model.setSearchQuery(query);
        console.log(query);
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7f0ce425._.js.map