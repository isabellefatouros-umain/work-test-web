...
(()=>{
    const e = new Error("Cannot find module '../resolvePromise.jsx'");
...
const RestaurantFilter = _s((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mobx$2d$react$2d$lite$2f$es$2f$observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["observer"])(_c = _s(function RestaurantFilterRender(props) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RestaurantFilter.RestaurantFilterRender.useEffect": ()=>{
            resolvePromise((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$restaurantSource$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDataFromApi"])("/restaurants"), props.model.filterResultsPromiseState);
        }
    }["RestaurantFilter.RestaurantFilterRender.useEffect"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
const model = {
    ...
    getRestaurantsShown () {
        ...
        if (this.topFilters.length > 0) {
            filtered = filtered.filter((r)=>this.topFilters.some((f)=>r.filter_ids?.includes(f)));
        }
        if (this.sideFilters.length > 0) {
            filtered = filtered.filter((r)=>this.sideFilters.some((f)=>r.filter_ids?.includes(f) || r.price_range_id === f));
        }
        return filtered;
    }
}; /*
...
//# sourceMappingURL=src_app_0410b057._.js.map