...
;
;
const SidebarFilter = observer(_c = function FilterRender(props) {
    function onTopFilterChangedACB(query) {
        props.model.setSearchQuery(query);
        console.log(query);
    }
...
;
;
const TopbarFilter = observer(_c = function FilterRender(props) {
    function onTopFilterChangedACB(query) {
        props.model.setSearchQuery(query);
        console.log(query);
    }
...
//# sourceMappingURL=src_app_2e610bae._.js.map